...
class RouteTest < ActiveSupport::TestCase
  ...
  test "details method should return route details json" do
    ...
    assert_equal 1, details[:id], "Returned route unique id is not as expected"
  ...
  test "estimated_time is set based on route and all uses of the route" do
    ...
    route.uses = uses
    route.save
    # Expected (0 + (123*10) / 11) because saving the parent sets total_time to 0 (no points)
    assert_equal 111, route.estimated_time
  end
end
