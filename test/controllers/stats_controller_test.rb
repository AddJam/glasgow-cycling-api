...
class StatsControllerTest < ActionController::TestCase
  test "should get stat hours" do
    ...
    assert_equal 5, json['hours'].length, "the requested number of hours should be returned"
  end
  ...
  test "should get stat weeks" do
    ...
    # Fetch the stats
    get :weeks, num_weeks: 1, format: :json
    assert_response :success

    json = JSON.parse(response.body)
    assert_not_nil json['overall'], "overall stats should be returned"
    assert_not_nil json['weeks'], "a list of weeks should be returned"
    assert_equal 1, json['weeks'].length, "there should be one day returned"
  end
end
